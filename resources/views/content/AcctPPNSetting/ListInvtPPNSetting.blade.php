...
<h3 class="page-title">
    <button onclick="location.href='{{ url('ppn-setting/edit-setting/101') }}'" name="Find" class="btn btn-sm btn-info" title="Back"><i class="fa fa-angle-left"></i>  Kembali</button>
    {{-- <b>Setting PPN</b> --}}
