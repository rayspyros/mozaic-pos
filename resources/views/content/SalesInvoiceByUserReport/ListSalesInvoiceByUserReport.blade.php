            ...
            <table id="example" style="width:100%" class="table table-striped table-bordered table-hover table-full-width">
                <thead>
                    <tr>
                        ...
                        <th style='text-align:center; width: 8%'>PPN</th>
                ...
                <tbody>
                    ...
                    @foreach ($data as $row)
                        <tr>
                            ...
                            <td style="text-align: right">{{ number_format($row['subtotal_amount']*0.11,2,'.',',') }}</td>
                            <td style="text-align: right">{{ number_format($row['subtotal_amount_after_discount']+$row['subtotal_amount']*0.11,2,'.',',') }}</td> 
                        </tr>
                    @endforeach
                </tbody>
            </table>
