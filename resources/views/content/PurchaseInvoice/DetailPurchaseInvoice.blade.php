                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-advance table-hover">
                        ...
                        <tr>
                            ...
                            <td colspan = "2" style='text-align  : right !important;'>{{ number_format($purchaseinvoice['total_amount']+$purchaseinvoice['total_amount']*0.11,2,',','.') }}</td>
                        </tr>
                        <tr>
                            <td colspan = "3"><b>PPN</b></td>
                            <td colspan = "2" style='text-align  : right !important;'>{{ number_format($purchaseinvoice['total_amount']*0.11,2,',','.') }}</td>
                        </tr>
                        <tr>
